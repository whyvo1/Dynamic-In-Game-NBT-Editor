...
public class SetValuePopup extends Popup {
    ...
    private static final StringNbtReader<NbtElement> NBT_READER = StringNbtReader.fromOps(NbtOps.INSTANCE);
    ...
    private static NbtElement tryParseNbt(String string) {
        try {
            return NBT_READER.readAsArgument(new StringReader(string));
