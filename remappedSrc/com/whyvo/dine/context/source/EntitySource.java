...
public class EntitySource implements NbtSource {
    ...
    private static CompoundTag finalGetNbt(@NotNull Entity entity) {
        TagValueOutput nbtWriteView;
        try (ProblemReporter.ScopedCollector logging = new ProblemReporter.ScopedCollector(entity.problemPath(), LOGGER)) {
            nbtWriteView = TagValueOutput.createWithContext(logging, entity.registryAccess());
