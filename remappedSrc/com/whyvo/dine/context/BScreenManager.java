...
public class BScreenManager {
    private static final Component NO_SCREEN = Component.translatable("dine.screen.no_screen");
    private static final MutableComponent CLOSE_ALL = Component.translatable("dine.rc.close_all");
    private static final MutableComponent TRY_PAUSE_GAME = Component.translatable("dine.rc.try_pause_game");
    private static final MutableComponent CONTINUE_GAME = Component.translatable("dine.rc.continue_game");
...
//        this.currentIndex = this.screens.size();
    ...
    public void render(GuiGraphics context, int mouseX, int mouseY) {
        ...
        for(int index = 0; index < this.screens.size(); index++) {
            ...
            int i = font.width(title);
            if(i > bw - 10) {
                int i0 = font.width(" ...");
                String trimmedTitle = font.plainSubstrByWidth(title, bw - 10 - i0) + " ...";
                context.drawString(font, trimmedTitle, start + 5, 7, 0xFFFFFFFF, false);
            }
            else {
                context.drawString(font, title, start + 5, 7, 0xFFFFFFFF, false);
            }
            if(index == this.currentIndex) {
