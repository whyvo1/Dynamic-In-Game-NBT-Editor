...
public class Config {
    ...
    private static final Path CONFIG_PATH = Minecraft.getInstance().gameDirectory.toPath().resolve("config").resolve("dine.prop");
    ...
    public static void refreshProperties() {
        ...
        try (FileInputStream inputStream = new FileInputStream(CONFIG_PATH.toFile())) {
            ...
            String s = prop.getProperty(DATA_COMMAND);
            dataCommand = s == null ? "data" : s;
