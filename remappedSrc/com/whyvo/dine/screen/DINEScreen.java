...
public class DINEScreen extends Screen {
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double horizontalAmount, double verticalAmount) {
        return super.mouseScrolled(mouseX, mouseY, horizontalAmount, verticalAmount) || this.screens.mouseScrolled((int) mouseX, (int) mouseY, horizontalAmount, verticalAmount, Screen.hasControlDown());
    }
